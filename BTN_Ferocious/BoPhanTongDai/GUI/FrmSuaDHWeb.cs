...
{
    public partial class FrmSuaDHWeb : Form
    {
        int ID;
        public FrmSuaDHWeb(int id)
        {
            this.ID = id;
            InitializeComponent();
        ...
        private void btnXacNhan_Click(object sender, EventArgs e)
        {
            ...
            if(tenKH != "" && diaChi != "" && SDT != "")
            {
                ...
                string sqlGetDonHang = "SELECT IDKhachHang, IDMonAn, IDChiNhanh FROM DONHANG_TONGDAI WHERE ID = @ID";
                DBManager dBManager = new DBManager();
                dBManager.Open();
                ...
                while (reader.Read())
                {
                    ...
                    {
                        string sqlUpdateDonHang = "UPDATE DONHANG_TONGDAI SET " +
                    ...
                    {
                        string sqlUpdateDonHang = "UPDATE DONHANG_TONGDAI SET IDMonAn = @IDMonAn, " +
